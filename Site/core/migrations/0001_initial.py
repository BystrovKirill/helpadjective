# Generated by Django 3.1.2 on 2022-12-15 11:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('volunteer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.user')),
            ],
        ),
        migrations.CreateModel(
            name='Invalid',
            fields=[
                ...
                ('fio', models.CharField(max_length=50)),
                ('invalid', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.user')),
            ],
        ),
    ]
